...
const { brl: brlES } = window.AppData;

// ----- Mock data específica desta aba -----
const ESTIM_PROJETOS_REF = [
...
// ----- Defaults para seções editáveis -----
const ESTIM_IMPLANTACAO_DEFAULT = [
...
const ESTIM_INCORPORACAO_DEFAULT = [
...
// ----- Helpers -----
const fmtR = (n) => (n || 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL', minimumFractionDigits: 0, maximumFractionDigits: 0 });
const fmtR2 = (n) => (n || 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL', minimumFractionDigits: 2, maximumFractionDigits: 2 });
const fmtNumES = (n, d = 2) => isFinite(n) ? n.toLocaleString('pt-BR', { minimumFractionDigits: d, maximumFractionDigits: d }) : '—';
const fmtPctES = (n) => isFinite(n) ? (n * 100).toLocaleString('pt-BR', { maximumFractionDigits: 1 }) + '%' : '—';
...
window.EstimativasScreen = EstimativasScreen;
